  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6 pb-4 sm:pb-8">
              ...
              >
                {plan.mostPopular && (
                  <div className="absolute -top-2 sm:-top-3 left-1/2 -translate-x-1/2 z-10">
                    <div className="flex items-center space-x-1 sm:px-4 py-1 sm:py-1.5 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full text-xs sm:text-sm font-semibold shadow-lg">
                ...
                <ul className="space-y-3 sm:space-y-4 sm-6 sm:mb-8">
